...
module.exports = {
  ...
  db: process.env.MONGODB || process.env.MONGOLAB_URI || 'mongodb://adopt:adopt123@ds041613.mongolab.com:41613/adopt',
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '631971350238751',
    clientSecret: process.env.FACEBOOK_SECRET || '9af8ea33dd2ccbe5e899987a5d189fd1',
